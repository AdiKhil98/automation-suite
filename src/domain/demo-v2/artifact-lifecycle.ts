...
const transitions: Readonly<Record<DemoV2ArtifactStatus, readonly DemoV2ArtifactStatus[]>> = {
  ...
  // Milestone 3B2A: from the review pause an operator may proceed to rendering for automatic
  // (structural) review. HUMAN_APPROVED and AUTO_REVIEW_PASSED remain unreachable in 3B2A.
  HUMAN_REVIEW_REQUIRED: ['RENDERING', 'HUMAN_APPROVED', 'REJECTED', 'REVISION_REQUIRED'],
